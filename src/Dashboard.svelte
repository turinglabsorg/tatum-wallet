<script>
    ...
    async function getTransactionForAccount(currency) {
        if (filter === currency) {
            transactions = await getTransactionsByCustomer({
        ...
        const accountId =
            currency === Currency.BTC
                ? localStorage.getItem("BTC_ACCOUNT_ID")
                : localStorage.getItem("ETH_ACCOUNT_ID");
...
<div class="row">
    <div class="col-md-6 col-sm-12 col-12 pl-0">
        ...
        {#if btcAccount}
            <div class="card cardWalet">
                <div class="card-body cardBodyP20">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="cardSubHeading">BTC balance</h5>
                        </div>
                    </div>
                    <div class="icoRight">
                    ...
                    <div class="row">
                        <div class="col-12 pl-0">
                            <h4 class="totalBalance mb-0">
                                {btcAccount.balance.accountBalance}
                                BTC
                            </h4>
                            <p class="m-0 amountDol">
                                ${parseFloat(btcAccount.balance.accountBalance) * btcExchangeRate}
                            </p>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 col-sm-12">
                            <button
                                class="btn btn-outlineSR w-sm-100"
                                on:click={() => redirect('BTC', true)}>Send BTC
                            </button>
                        </div>
                        <div class="col-md-6 col-12 col-sm-12">
                            <button
                                class="btn btn-outlineSR w-sm-100"
                                on:click={() => redirect('BTC', false)}>Request
                                BTC
                            </button>
                        </div>
                    </div>
        ...
        {#if ethAccount}
            <div class="card cardWalet mt-4">
                <div class="card-body cardBodyP20">
                    <div class="row">
                        <div class="col-12">
                            <h5 class="cardSubHeading">ETH balance</h5>
                        </div>
                    </div>
                    <div class="icoRight">
                    ...
                    <div class="row">
                        <div class="col-12 pl-0">
                            <h4 class="totalBalance mb-0">
                                {ethAccount.balance.accountBalance}
                                ETH
                            </h4>
                            <p class="m-0 amountDol">
                                ${parseFloat(ethAccount.balance.accountBalance) * ethExchangeRate}
                            </p>
                            <p class="amountDol code pt-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 col-sm-12">
                            <button
                                class="btn btn-outlineSR w-sm-100"
                                on:click={() => redirect('ETH', true)}>Send ETH
                            </button>
                        </div>
                        <div class="col-md-6 col-12 col-sm-12">
                            <button
                                class="btn btn-outlineSR w-sm-100"
                                on:click={() => redirect('ETH', false)}>Request
                                ETH
                            </button>
                        </div>
                    </div>
        ...
        {/if}
        <p class="mt20">
            <a href="/#add" class="atag" on:click={generateAccounts}><i
    ...
    {#if transactions.length}
        <div class="col-md-6 col-sm-12 col-12 pl-0">
            ...
            <div class="btns mb20">
                <button
                    class="btn btn-outline {filter === 'BTC' ? 'btn-outline-active' : ''}"
                    on:click={() => getTransactionForAccount('BTC')}>BTC
                </button>
                <button
                    class="btn btn-outline {filter === 'ETH' ? 'btn-outline-active' : ''}"
